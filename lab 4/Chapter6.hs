...
higherOrderSequenceApplication _ _ 0 0 = 0
higherOrderSequenceApplication intApplication op a b 
  | a>b = error("Sory, a>b")
  | a==b = op a 
  | otherwise = intApplication  (op a) (higherOrderSequenceApplication intApplication op (a+1) b)
